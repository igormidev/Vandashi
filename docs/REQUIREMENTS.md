...
| ASSET-04/16        | Verify successful native asset-library drops in both consumers, including a differently named byte-identical duplicate. Verify selected-asset AI filename/sidecar/reference repair and blocked deletion of a referenced file. Picker, GIF, actual image clipboard, audio/video playback, nested-folder AI and search evidence are accepted.     |
